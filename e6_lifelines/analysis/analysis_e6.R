...
CV_plotter <- function(results_df, x_order, results_order, ques_type, x_labels, sum_meaning, sum_pd) {
    ...
    grouped_box_plot <- ggplot() + 
      scale_x_discrete() + 
      geom_rect(aes(xmin = 0.4, xmax = Inf, ymin = sum_meaning["1st Qu."], ymax = sum_meaning["3rd Qu."]),
                alpha = 1, fill = "gray60") + #"#56B4E9") +
      geom_rect(aes(xmin = 0.4, xmax = Inf, ymin = sum_pd["1st Qu."], ymax = sum_pd["3rd Qu."]),
                alpha = 1, fill = "gray60") + #"#009E73") + 
...
MakePCAFunction <- function(score_features_df) {
    ...
    meaning_features <- lmer(data = score_features_df, 
                               meaningfulness ~ PC1 + PC2 + PC3 + PC4 + PC5 + (1 | subject) + (1 | plot_names))
    ...
    pd_features <- lmer(data = score_features_df, 
                      personal_desirability ~ PC1 + PC2 + PC3 + PC4 + PC5 + (1 | subject) + (1 | plot_names))
...
CrossValidationAnalysisWtPredictors <- function(dat, dat_long, n_ss, n_plots) {
    ...
    predictors_plot <- predictors_plot + 
      ...
      # One-sided Wilcox test
      ggplot2::annotate("text", x = meaning_bottom_x, y = meaning_bottom_y, size = 8, label = p_value_stars_meaning[[1]]) + 
      ggplot2::annotate("text", x = meaning_bottom_x + 1, y = meaning_bottom_y, size = 8, label = p_value_stars_meaning[[2]]) + 
      ggplot2::annotate("text", x = meaning_bottom_x + 2, y = meaning_bottom_y, size = 8, label = p_value_stars_meaning[[3]]) + 
      ggplot2::annotate("text", x = meaning_bottom_x + 3, y = meaning_bottom_y, size = 8, label = p_value_stars_meaning[[4]]) + 
      ggplot2::annotate("text", x = meaning_bottom_x + 4, y = meaning_bottom_y, size = 8, label = p_value_stars_meaning[[5]]) + 
      ggplot2::annotate("text", x = meaning_bottom_x + 5, y = meaning_bottom_y, size = 8, label = p_value_stars_meaning[[6]]) + 
      ggplot2::annotate("text", x = meaning_bottom_x + 6, y = meaning_bottom_y, size = 8, label = p_value_stars_meaning[[7]]) + 
      ggplot2::annotate("text", x = meaning_bottom_x + 7, y = meaning_bottom_y, size = 8, label = p_value_stars_meaning[[8]]) + 
      ggplot2::annotate("text", x = meaning_bottom_x + 8, y = meaning_bottom_y, size = 8, label = p_value_stars_meaning[[9]]) + 
      ggplot2::annotate("text", x = meaning_bottom_x + 9, y = meaning_bottom_y, size = 8, label = p_value_stars_meaning[[10]]) + 
      ggplot2::annotate("text", x = meaning_bottom_x + 10, y = meaning_bottom_y, size = 8, label = p_value_stars_meaning[[11]]) + 
      ggplot2::annotate("text", x = meaning_bottom_x + 11, y = meaning_bottom_y, size = 8, label = p_value_stars_meaning[[12]]) + 
      ggplot2::annotate("text", x = meaning_bottom_x + 12, y = meaning_bottom_y, size = 8, label = p_value_stars_meaning[[13]]) + 
      ggplot2::annotate("text", x = meaning_bottom_x + 13, y = meaning_bottom_y, size = 8, label = p_value_stars_meaning[[14]]) + 
      ggplot2::annotate("text", x = meaning_bottom_x + 14, y = meaning_bottom_y, size = 8, label = p_value_stars_meaning[[15]]) + 
      ggplot2::annotate("text", x = meaning_bottom_x + 15, y = meaning_bottom_y, size = 8, label = p_value_stars_meaning[[16]]) + 
      ggplot2::annotate("text", x = meaning_bottom_x + 16, y = meaning_bottom_y, size = 8, label = p_value_stars_meaning[[17]]) + 
      ggplot2::annotate("text", x = meaning_bottom_x + 17, y = meaning_bottom_y, size = 8, label = p_value_stars_meaning[[18]]) + 
      ggplot2::annotate("text", x = meaning_bottom_x + 18, y = meaning_bottom_y, size = 8, label = p_value_stars_meaning[[19]]) + 
      ggplot2::annotate("text", x = meaning_bottom_x + 19, y = meaning_bottom_y, size = 8, label = p_value_stars_meaning[[20]]) + 
